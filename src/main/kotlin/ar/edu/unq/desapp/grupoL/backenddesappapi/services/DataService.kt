...
class DataService {
    ...
    fun initialize() {
        ...
        userRepository.save(User("Roberto", "Perez", "rp@gmail.com", "rprprprprp", "Rope111*", "2222222222222222222222", "22222222", 10, 2))
        activityRepository.save(Activity(LocalDateTime.now(),
            Quotation("BTCUSDT", 3000.0),
            userRepository.findByEmail("ab@gmail.com"),
            20.0, ActivityType.SALE))
        activityRepository.save(Activity(LocalDateTime.now(),
            Quotation("ETHUSDT", 3200.0),
            userRepository.findByEmail("ab@gmail.com"),
            30.0, ActivityType.BUY))
        activityRepository.save(Activity(LocalDateTime.now(),
            Quotation("BNBUSDT", 3400.0),
            userRepository.findByEmail("ab@gmail.com"),
            40.0, ActivityType.SALE))
        activityRepository.save(Activity(LocalDateTime.now(),
            Quotation("NEOUSDT", 3500.0),
            userRepository.findByEmail("ab@gmail.com"),
